CREATE DATABASE proj1 AUTOMATIC STORAGE YES USING CODESET UTF-8 TERRITORY DEFAULT COLLATE USING SYSTEM PAGESIZE 32768;

UPDATE DATABASE CONFIGURATION FOR proj1 USING LOGFILSIZ 7500 ;
UPDATE DATABASE CONFIGURATION FOR proj1 USING LOGPRIMARY 15;

UPDATE DATABASE CONFIGURATION FOR proj1 USING APPLHEAPSZ 2560; 
UPDATE DATABASE CONFIGURATION FOR proj1 USING STMTHEAP 8192;

CONNECT TO proj1 ;
DROP TABLESPACE USERSPACE1 ;
CREATE Bufferpool proj1BP IMMEDIATE SIZE -1 PAGESIZE 32K ;
CREATE Bufferpool proj1TEMPBP IMMEDIATE SIZE -1 PAGESIZE 32K ;
CREATE Bufferpool proj1SYSBP IMMEDIATE SIZE -1 PAGESIZE 32K ;
CONNECT RESET ;

CONNECT TO proj1;
CREATE LARGE TABLESPACE proj1DATA PAGESIZE 32K BUFFERPOOL proj1BP ;
CREATE USER TEMPORARY TABLESPACE USERTEMP1 PAGESIZE 32K BUFFERPOOL proj1TEMPBP ;
CREATE SYSTEM TEMPORARY TABLESPACE TEMPSYS1 PAGESIZE 32K BUFFERPOOL proj1SYSBP;
CONNECT RESET ;
